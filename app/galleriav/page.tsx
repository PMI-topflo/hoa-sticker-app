  ...
  return (
    <main className="assoc-page">
      ...
      <section className="section">
        ...
        <a
          href="https://drive.google.com/drive/folders/132VY3u0BsOplKJcudFAkCUYK4UEDs_ok?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1f4vvoamEA2s0r4MP_wFcDGU9pzjgwXNE?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/120rT2dHRMPAv0g2wQE4dN_EHJvA8biRE?usp=drive_link"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1UEAEJLGsT5DPgfiYegogS9x8Jw5VySXN?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1Bg6besfQ2IC5aFms-M5d2VT1a67DPBzZ?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1cQM7l6EBTguIz2sn8E9rg2kRIK4fgghF"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/14o6VpsdAcgl4YPnNbNGKk8VfCqRlQZJZ?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/18fIyC-qRrmDqdN6hVQo-YIU18ouwaPgY?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1A8cPeY1ocPlqCUKE9pxUDbHt4yN_FFyl?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/15k8aTPVr4WbXj66oxz3RBYgZ6MJSVCpY?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
        ...
        <a
          href="https://drive.google.com/drive/folders/1yi1WAA1C4F0oNn1T8Ij5AXL2GQ1oyWvB?usp=sharing"
          target="_blank"
          rel="noreferrer"
          className="dcard"
        >
